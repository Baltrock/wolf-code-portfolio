...
class ReviewFormsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create review_form" do
    assert_difference("ReviewForm.count") do
      post review_forms_url, params: { review_form: { rating: @review_form.rating, review: @review_form.review, review_title: @review_form.review_title, user_id: @review_form.user_id } }
    end
  ...
  test "should update review_form" do
    patch review_form_url(@review_form), params: { review_form: { rating: @review_form.rating, review: @review_form.review, review_title: @review_form.review_title, user_id: @review_form.user_id } }
